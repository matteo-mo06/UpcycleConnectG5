...
INSERT INTO PERMISSION (id_permission, name_permission, domain) VALUES
    ...
    ('73875cfa-b134-4b6d-9a46-43ea4fe9b500', 'validate_deposit',              'lockers');
...
SELECT UUID(), '77e2bd9a-a1af-44f7-8f0e-edfb97f9c0ab', id_permission FROM PERMISSION;
...
INSERT INTO ROLE_PERMISSION (id, role_id, permission_id)
SELECT UUID(), '11111111-1111-1111-1111-000000000003', id_permission
FROM PERMISSION
WHERE name_permission IN (
    'buy_announcement',
    'register_event',
