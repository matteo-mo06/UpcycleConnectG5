...
func CreateAnnouncement(a models.Announcement) error {
	_, err := config.Conn.Exec(`
		INSERT INTO ANNOUNCEMENT
			(id_announcement, id_category, title_announcement, address_annoucement, city, postal,
			 description_annoucement, availability_date, price, request, state_annoucement)
		VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, a.Id_announcement, a.Id_category, a.Title_announcement,
		a.Address_annoucement, a.City, a.Postal, a.Description_annoucement, a.Availability_date, a.Price,
...
func UpdateAnnouncement(a models.Announcement) error {
	_, err := config.Conn.Exec(`
		UPDATE ANNOUNCEMENT SET
			id_category = ?, title_announcement = ?, address_annoucement = ?, city = ?, postal = ?,
			description_annoucement = ?, availability_date = ?, price = ?, request = ?, state_annoucement = ?
		WHERE id_announcement = ?`,
		a.Id_category, a.Title_announcement,
