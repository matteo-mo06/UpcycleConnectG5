-- =============================================================
-- Script de deploiement de la base de donnees UpcycleConnect
-- Compatible MariaDB 10.x / 11.x
-- A executer UNE SEULE FOIS sur la base existante du NAS
-- =============================================================
-- Prerequis :
--   Une base de donnees vide deja creee sur le NAS
--   Un utilisateur avec les droits CREATE, ALTER, INSERT,
--   SELECT, UPDATE, DELETE sur cette base
--
-- Usage depuis le NAS (ou depuis le serveur web si le port 3306 est ouvert) :
--   mysql -h IP_NAS -u UTILISATEUR -p NOM_BASE < db/deploy_nas.sql
--
-- Autoriser la connexion depuis le serveur web (a faire sur le NAS) :
--   GRANT SELECT, INSERT, UPDATE, DELETE ON NOM_BASE.* TO 'UTILISATEUR'@'IP_SERVEUR';
--   FLUSH PRIVILEGES;
-- =============================================================
...
-- ============================================================
-- Migration 000001 : schema initial
-- ============================================================
...
INSERT INTO `category` VALUES ('aaaaaaaa-aaaa-aaaa-aaaa-000000000001','Couture & Textile','Retouches, creations et recyclage textile'),('aaaaaaaa-aaaa-aaaa-aaaa-000000000002','Menuiserie & Bois','Reparation et creation de meubles en bois'),('aaaaaaaa-aaaa-aaaa-aaaa-000000000003','Electronique','Reparation d\'appareils electroniques'),('aaaaaaaa-aaaa-aaaa-aaaa-000000000004','Maroquinerie','Reparation et creation en cuir'),('aaaaaaaa-aaaa-aaaa-aaaa-000000000005','Ceramique & Poterie','Creation et restauration ceramique'),('aaaaaaaa-aaaa-aaaa-aaaa-000000000006','Jardinage & Compostage','Compost, recuperation dechets verts, jardinage ecologique'),('aaaaaaaa-aaaa-aaaa-aaaa-000000000007','Peinture & Decoration','Remise en peinture et relooking de mobilier usage'),('aaaaaaaa-aaaa-aaaa-aaaa-000000000008','Recuperation Metaux','Travail des metaux et materiaux de recuperation industrielle'),('aaaaaaaa-aaaa-aaaa-aaaa-000000000009','Papeterie & Carton','Recyclage papier, carton et creations associees'),('aaaaaaaa-aaaa-aaaa-aaaa-000000000010','Mode & Couture Upcyclee','Transformation de vetements et accessoires usages');
...
-- ============================================================
-- Migration 000004 : schema formations
-- ============================================================
...
-- ============================================================
-- Migration 000005 : rejection_reason sur event et announcement
-- ============================================================
...
-- ============================================================
-- Migration 000007 : systeme de score upcycling
-- ============================================================
...
INSERT INTO `score_action` (`action_type`, `points`, `description`) VALUES
  ('project_created',        50,  'Creation d un projet collectif'),
  ('formation_registration', 30,  'Inscription a une formation'),
  ('project_registration',   25,  'Inscription a un projet collectif'),
  ('event_registration',     15,  'Inscription a un evenement'),
  ('deposit_validated',      20,  'Depot d objet physiquement valide'),
  ('announcement_sold',      15,  'Objet recupere cote vendeur'),
  ('announcement_bought',    10,  'Objet recupere cote acheteur'),
  ('sanction_warning',       -15, 'Avertissement recu'),
  ('sanction_suspension',    -40, 'Suspension recue');

-- ============================================================
-- Migration 000008 : schema projets
-- ============================================================
...
-- ============================================================
-- Migration 000009 : moderation projets
-- ============================================================
...
-- ============================================================
-- Migration 000010 : avatar utilisateur
-- ============================================================

ALTER TABLE `user` ADD COLUMN `avatar_url` VARCHAR(500) NULL;

-- ============================================================
-- Migration 000011 : flag tutoriel
-- ============================================================
...
-- toutes les migrations au demarrage et echouerait.
-- ============================================================
